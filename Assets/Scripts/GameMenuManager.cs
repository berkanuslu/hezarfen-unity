...
public class GameMenuManager : MonoBehaviour
{
	...
	void BuySpeedPowerup()
	{
		if (PreferencesManager.Instance.GetCoins() >= shopPrices[0])
		{
			...
			EventManager.Instance.SendSpendVirtualCurrency(shopPrices[0], "ExtraSpeed");
	...
	void BuyShieldPowerup()
	{
		if (PreferencesManager.Instance.GetCoins() >= shopPrices[1])
		{
			...
			EventManager.Instance.SendSpendVirtualCurrency(shopPrices[1], "Shield");
	...
	void BuyAbracadabraPowerup()
	{
		if (PreferencesManager.Instance.GetCoins() >= shopPrices[2])
		{
			...
			EventManager.Instance.SendSpendVirtualCurrency(shopPrices[2], "Abracadabra");
	...
	void BuyRevivePowerup()
	{
		if (PreferencesManager.Instance.GetCoins() >= shopPrices[3])
		{
			...
			EventManager.Instance.SendSpendVirtualCurrency(shopPrices[3], "Revive");
	...
	public void ShowEnd()
	{
		...
		EventManager.Instance.SendEarnVirtualCurrency(currentCoins);
